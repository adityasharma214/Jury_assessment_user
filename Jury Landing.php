...
$SQL = "SELECT Name, Enrollment, Time, Status FROM `scheduled` WHERE `Jury_pannel`='$Panel_member' AND Date=CURDATE();";
            ...
            <tbody>
                ...
                ?>
                    <tr data-userid="<?php echo $rows['Enrollment']; ?>" data-name="<?php echo $rows['Name']; ?>">
                        ...
                        <td hidden><?php echo $rows['Name']; ?></td>
                        <td><?php echo $rows['Name']; ?></td>
                        <td><?php echo $rows['Enrollment']; ?></td>
                        <td><?php echo $rows['Time']; ?></td>
                        <td style="align-items: center;"><button id="student_details" type="button" class="btn" style="background-color:<?php echo $color ?>; color:aliceblue;" <?php if ($rows['Status'] == '1'){ ?> disabled <?php   } ?>><?php echo $text ?></button></td>
                    </tr>
                <?php
                }
